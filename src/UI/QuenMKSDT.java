 ...
 * @author Lenovo
 */
public class QuenMKSDT extends javax.swing.JDialog {

    /**
     * Creates new form QuenMatKhau
     */
    public QuenMKSDT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Forgot_SDT.png"))); // NOI18N
        ...
        jLabel4.setText("Đổi mật khẩu bằng SDT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuenMKSDT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuenMKSDT dialog = new QuenMKSDT(new javax.swing.JFrame(), true);
...
//        
    ...
    public void updateStatus() {
        ...
        if (!testTime) {
            btnGui.setBackground(new Color(236, 135, 192));
            btnXacNhan.setBackground(new Color(128, 128, 128));
        } else {
            btnXacNhan.setBackground(new Color(236, 135, 192));
